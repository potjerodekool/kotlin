...
public class MapPlatformClassToKotlinFix extends JetIntentionAction<JetReferenceExpression> {
    ...
    public void invoke(@NotNull Project project, Editor editor, PsiFile file) throws IncorrectOperationException {
        BindingContext context = KotlinCacheManagerUtil.getHeadersBindingContext((JetFile) file);
    ...
    public static JetIntentionActionFactory createFactory() {
        return new JetIntentionActionFactory() {
            ...
            public IntentionAction createAction(Diagnostic diagnostic) {
                ...
                BindingContext context = KotlinCacheManagerUtil.getHeadersBindingContext((JetFile) psiFile);
