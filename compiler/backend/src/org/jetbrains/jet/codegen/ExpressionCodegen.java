...
public class ExpressionCodegen extends JetVisitor<StackValue, StackValue> implements LocalLookup {
    ...
    public StackValue.Property intermediateValueForProperty(
        ...
        boolean isCallToTraitImpl = isSuper && isInterface;
        ...
        if (!forceField) {
            ...
            if (isInsideClass &&
                ...
                if (propertyDescriptor.getGetter() != null) {
                    getter = typeMapper.
                            mapGetterSignature(propertyDescriptor, isCallToTraitImpl ? OwnerKind.TRAIT_IMPL : OwnerKind.IMPLEMENTATION).
            ...
            if (propertyDescriptor.isVar()) {
                if (propertyDescriptor.getSetter() != null) {
                    if (isInsideClass && !isExtensionProperty &&
                        ...
                        setter = typeMapper.
                                mapSetterSignature(propertyDescriptor, isCallToTraitImpl ? OwnerKind.TRAIT_IMPL : OwnerKind.IMPLEMENTATION).
                                getJvmMethodSignature().getAsmMethod();
                    }
                }
