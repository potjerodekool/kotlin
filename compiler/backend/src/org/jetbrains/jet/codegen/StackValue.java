...
public abstract class StackValue {
    ...
    static class Field extends StackValueWithReceiver {
    ...
    static class Property extends StackValueWithReceiver {
        @Nullable
        ...
        public void put(Type type, InstructionAdapter v) {
            if (getter == null) {
                ...
                v.visitMethodInsn(getter.getInvokeOpcode(), methodOwner.getInternalName(), getAccessorName(true), method.getDescriptor());
            }
            coerceTo(type, v);
        }
        ...
        public void store(Type topOfStackType, InstructionAdapter v) {
            ...
            if (setter == null) {
                ...
                v.visitMethodInsn(setter.getInvokeOpcode(), methodOwner.getInternalName(), getAccessorName(false), method.getDescriptor());
            }
        }

        private String getAccessorName(boolean isGetter) {
            return JetTypeMapper.getPropertyAccessorName(descriptor, isGetter);
        }
    }
    ...
    static class FieldForSharedVar extends StackValueWithReceiver {
        final JvmClassName owner;
        final String name;
    ...
    abstract static class StackValueWithReceiver extends StackValue {

        protected final boolean isStatic;

        public StackValueWithReceiver(@NotNull Type type, boolean isStatic) {
            super(type);
